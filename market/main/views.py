...
def itemspage(request):
    ...
    if request.method == "POST":
        ...
        if purchased_item:
            ...
            messages.success(request, f"Congratulation, You have brought {purchased_item} for {purchased_item_object.price}")
...
def loginpage(request):
    ...
    if request.method == "POST":
        ...
        if user is not None:
            ...
            messages.error(request, "The Combination of Username and Password is not found")
